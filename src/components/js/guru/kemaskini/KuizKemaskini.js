...
import { kemaskini, rand, getKuiz, useTitle } from "../../utils";
...
function KemaskiniKuizDetail()
{
    ...
    function handleSubmit(e)
    {
        ...
        kemaskini( kuiz, user.token, 'kuiz' ).then( data => {
            if( data.success )
            {
        ...
        <Box>
            ...
            <BoxBody>
              ...
              <button 
                ...
                return setKuiz( {...kuiz, soalan: [...kuiz.soalan, {
                    s_id: 'new-' + rand(),
                    s_teks: '',
                    jawapan: [
