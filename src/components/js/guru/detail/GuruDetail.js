...
export function GuruDetail( {user, ...rest} )
{
    ...
    useEffect( () => {
        ...
        {
            getTingkatanByGuru( guru.g_id ).then( data =>
            {
                if( data.success )
                {
                    // console.log( data );
            ...
            getKuizByGuru( guru.g_id ).then( data => {
                if( data.success )
                {
...
export function SenaraiTingkatan( {ting, ...rest} )
{
    ...
    useEffect( () => {
        ...
        getMuridByTing( ting.kt_id ).then( data => {
            if( data.success )
            {
