...
import { baseUrl, getKuiz, Url, useTitle } from '../utils';
...
function JawabKuiz(props)
{
    ...
    return (
        <JawabKuizContext.Provider value={ { kuiz, setKuiz, currentSoalan, setCurrentSoalan } }>
            <Jawab {...props}></Jawab>
        </JawabKuizContext.Provider>
    );
}
