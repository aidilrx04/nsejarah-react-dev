    ...
    return (
        user.loggedin
            ? (
                <Box>
                    <BoxHeader>
                        <i className={ `fas ${iconType}` } /> { title }
                    </BoxHeader>
                    <BoxBody>
                        <b>Nama: </b> { user.data.g_nama } { user.data.m_nama } <br />
                        <b>No. K/P: </b> { user.data.g_nokp } { user.data.m_nokp } <br />
                        <br />
                        <button className="link bg3" style={ { fontSize: '16px' } } onClick={ () => user.logout() }>
